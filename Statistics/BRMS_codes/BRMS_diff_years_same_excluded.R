...
melted_diffs_selected_try = readRDS("Only_diff_year_15th_Aug_BRMS.RDS")
...
saveRDS(model1,"model1_jacc_diff_year_ag_15th_same_excluded.RDS")
...
saveRDS(model1,"model1_BC_diff_year_ag_15th_same_excluded.RDS")
...
saveRDS(model1,"model1_jacc_diff_year_ag_15th_same_excluded_no_mom_off.RDS")
...
saveRDS(model1,"model1_BC_diff_year_ag_15th_same_excluded_no_mom_off.RDS")
