...
jacc_dissimilarity = readRDS("bac_dist_jac_not_rar.RDS")
jacc_dissimilarity_rar = readRDS("bac_dist_jac_rar.RDS")
BC_dissimilarity = readRDS("bac_dist_BC_not_rar.RDS")
BC_dissimilarity_rar = readRDS("bac_dist_BC_rar.RDS")
...
melted_jaccard_rar <- reshape2::melt(as.matrix(jacc_dissimilarity_rar), varnames = c("Sample1", "Sample2"), value.name = "Jaccard_Dissimilarity")
melted_BC_rar <- reshape2::melt(as.matrix(BC_dissimilarity_rar), varnames = c("Sample1", "Sample2"), value.name = "BC_Dissimilarity")


unique(melted_BC$Sample1 == melted_jaccard$Sample1)
unique(melted_BC$Sample2 == melted_jaccard$Sample2) # Ok

unique(melted_BC_rar$Sample1 == melted_jaccard$Sample1)
unique(melted_BC_rar$Sample2 == melted_jaccard$Sample2) # Ok

unique(melted_jaccard_rar$Sample1 == melted_jaccard$Sample1)
unique(melted_jaccard_rar$Sample2 == melted_jaccard$Sample2) # Ok

#### Reshape 
melted_diffs = melted_jaccard  
melted_diffs$BC_dissimilarity = melted_BC$BC_Dissimilarity 
melted_diffs$BC_dissimilarity_rar = melted_BC_rar$BC_Dissimilarity 
melted_diffs$melted_jaccard_rar = melted_jaccard_rar$Jaccard_Dissimilarity 
...
melted_diffs$Jaccard_Similarity_rar = 1 - melted_diffs$melted_jaccard_rar
melted_diffs$BC_Similarity_rar = 1 - melted_diffs$BC_dissimilarity_rar
...
melted_diffs <- melted_diffs %>%
  ...
  dplyr::select(Sample1, Sample2, Jaccard_Similarity,BC_Similarity ,Jaccard_Similarity_rar, BC_Similarity_rar)
...
melted_diffs$masting_1 = ifelse(melted_diffs$mast1 == melted_diffs$mast2, 1, 0)

table(melted_diffs$masting_1)


melted_diffs =  melted_diffs %>%
  mutate(
    masting_factor = case_when( 
      melted_diffs$mast2 == "mast" & melted_diffs$mast1  == "mast" ~ "2_mast",
      melted_diffs$mast2 == "non-mast" & melted_diffs$mast1  == "non-mast" ~ "1_non-mast",
      TRUE ~ "3_mixed" # renamed here
      
    ))
table(melted_diffs$masting_factor)
...
summary(melted_diffs_selected$read_dist)
saveRDS(melted_diffs_selected, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/Full_data_set_BRMS.RDS")

### melted pre august 15th
### Select until 15th august
limit_15th = melted_diffs_selected[melted_diffs_selected$day_of_year1 < 227,]
limit_15th = limit_15th[limit_15th$day_of_year2 < 227,]



saveRDS(limit_15th, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/Full_data_set__15th_Aug_BRMS.RDS")

## only same year comparisons 
limit_15th_selected_same_year = limit_15th[limit_15th$same_year == 1,]
saveRDS(limit_15th_selected_same_year, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/Only_same_year_15th_Aug_BRMS.RDS")

limit_15th_selected_diff_year = limit_15th[limit_15th$same_year == 0,]
saveRDS(limit_15th_selected_diff_year, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/Only_diff_year_15th_Aug_BRMS.RDS")



### Remove mixed years 
limit_15th_selected_diff_year_no_mixed = limit_15th_selected_diff_year[which(limit_15th_selected_diff_year$mast1 ==limit_15th_selected_diff_year$mast2),]
saveRDS(limit_15th_selected_diff_year_no_mixed, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/Only_diff_year_15th_Aug_BRMS_no_mixed.RDS")
...
saveRDS(melted_diffs_selected_known_mom_pups, "/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/melted_diffs_selected_known_mom_pups_BRMS.RDS")



###boxplot_other_offspring_similiarty
mom_off = melted_diffs_selected[melted_diffs_selected$mother_offspring == 1,]
melted_diffs_selected_known_mom_pups = melted_diffs_selected[melted_diffs_selected$squirrel1 %in% squirrelID_tot
                                                             & melted_diffs_selected$squirrel2 %in% squirrelID_tot,]
melted_diffs_selected_known_mom_pups = melted_diffs_selected_known_mom_pups[which(melted_diffs_selected_known_mom_pups$mast1 == melted_diffs_selected_known_mom_pups$mast2),]

a = ggplot(melted_diffs_selected, 
       aes(x = factor(mother_offspring ), y = BC_Similarity, fill = factor(masting))) +
  geom_boxplot() +
  labs(x = "mother_offspring", y = "BC Similarity", fill = "masting") +
  theme_classic()

a

b =  ggplot(melted_diffs_selected, 
               aes(x = factor(mother_offspring ), y = BC_Similarity, fill = factor(masting))) +
  geom_boxplot() +
  labs(x = "mother_offspring", y = "BC Similarity", fill = "masting") +
  theme_classic()
...
### this could be a way --- but let's shuffle only mothers....

melted_diffs_selected$mother1



#### new analysis Lauren idea ------------
### Divide dataframe in two 
melted_diffs_selected_mast = melted_diffs_selected[melted_diffs_selected$masting == 1,]
melted_diffs_selected__non_mast = melted_diffs_selected[melted_diffs_selected$masting == 0,]
melted_diffs_selected__non_mast_no_mixed = melted_diffs_selected__non_mast[melted_diffs_selected__non_mast$mast1 != melted_diffs_selected__non_mast$mast2,]

saveRDS(melted_diffs_selected_mast,"/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/melted_diffs_selected_mast.RDS")
saveRDS(melted_diffs_selected__non_mast,"/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/melted_diffs_selected__non_mast.RDS")
saveRDS(melted_diffs_selected__non_mast_no_mixed,"/Users/gabri/Library/CloudStorage/OneDrive-UniversityofArizona/Squirrels/masting_project/BRMS_data_again/melted_diffs_selected__non_mast_no_mixed.RDS")

melted_diffs_selected_mast$Jaccard_Similarity_rar