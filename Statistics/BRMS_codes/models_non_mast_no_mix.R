...
melted_diffs_selected_try = readRDS("melted_diffs_selected__non_mast_no_mixed.RDS")
...
saveRDS(model1,"model1_jacc_non_mast_non_rar_no_mix.RDS")
...
saveRDS(model1,"model1_BC_non_mast_non_rar_no_mix.RDS")
...
saveRDS(model1,"model1_jacc_non_mast_rar_no_mix.RDS")
...
saveRDS(model1,"model1_BC_non_mast_rar_no_mix.RDS")